    ...
    <div className="stack">
      ...
      {!year ? (
        ...
        <>
          ...
          <CompetitionsTable comps={comps} myCode={session.code} role="admin" basePath="/admin/competitions" canPublish defaultEvent={event ? { id: event.id, name: event.name } : null} />
        </>
      )}
    </div>
  );
