            ...
            <span>
              ...
              <span className="form-hint">
                {f.visibleToStudents
                  ...
                  : "นักเรียนมองไม่เห็นและสมัครเองไม่ได้ · ครูประจำชั้นก็สมัครแทนไม่ได้ — ลงชื่อได้เฉพาะครูเจ้าของรายการ ครูในหมวดเดียวกัน หรือผู้ดูแลระบบ (ใช้กับรายการที่ต้องคัดตัวก่อน)"}
              </span>
            </span>
          </label>
        </div>
