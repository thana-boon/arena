...
export const ACTION_LABEL: Record<string, string> = {
  ...
  create_cert_template: "สร้างแบบเกียรติบัตรในงาน",
  delete_cert_template: "ลบแบบเกียรติบัตรในงาน",
  set_default_cert_template: "ตั้งแบบหลักของงาน",
  save_cert_preset: "บันทึกแม่แบบเริ่มต้น",
  update_cert_preset: "แก้ไขแม่แบบเริ่มต้น",
  delete_cert_preset: "ลบแม่แบบเริ่มต้น",
  save_sig_preset: "บันทึกลายเซ็นที่ใช้บ่อย",
  delete_sig_preset: "ลบลายเซ็นที่ใช้บ่อย",
...
const DETAIL_LABEL: Record<string, string> = {
  ...
  presetId: "แม่แบบเริ่มต้น",
  competitions: "จำนวนรายการที่ผูก",
