 ...
 *
 * ⚠ ห้ามแยกเป็นสองชุด: วันหนึ่งมันจะหลุดจากกัน แล้วจะมีคนเข้าทาง SSO ได้ทั้งที่เข้าทางรหัสผ่านไม่ได้
 * (หรือกลับกัน) ซึ่งเป็นบั๊กด้านสิทธิ์ที่หาไม่เจอจนกว่าจะมีคนบ่น
 *
